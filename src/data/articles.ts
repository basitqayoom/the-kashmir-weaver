...
export const articles: Article[] = [
  {
    ...
    readTime: "5 min read",
    image: `${CDN}/solid-cashmere-pashmina.jpg`,
    date: "March 27, 2026",
    content: `## Why Pashmina Makes an Extraordinary Gift
...
Pashmina improves with age. The fibres grow softer with gentle wear and washing. A shawl gifted today will look and feel better in five years than it does now — which means the recipient is reminded of your generosity not once, but every time they reach for it.`,
  },
  {
    ...
    readTime: "7 min read",
    image: `${CDN}/khankhah-shah-hamdan-ra-srinagar.jpg`,
    date: "March 27, 2026",
    content: `## The Place Where Pashmina Is Born
...
That is what makes it different. Not a brand name. Not a marketing claim. The geography, the animal, and the hands.`,
  ...
  {
    slug: "eight-ways-to-style-your-shawl",
    title: "Eight Practical Ways to Wear a Pashmina Shawl",
    category: "Style Guide",
    categoryColor: "bg-gold text-charcoal",
    excerpt:
      "A single shawl, eight distinct looks. From boardroom to beach evening, here is how to get the most from one piece of handwoven Pashmina.",
    readTime: "6 min read",
    image: `${CDN}/pashmina-kani-shawl-artisan-color.webp`,
    date: "March 27, 2026",
    content: `## One Shawl, Eight Looks
...
These styling options work because of how handwoven Pashmina behaves. It drapes naturally, holds a gentle fold without being pinned, and does not slip off the shoulder the way silk does. The fabric cooperates with you rather than fighting you — which is what makes it so pleasant to wear day after day.`,
  },
  {
    ...
    image: `${CDN}/kani1.jpg`,
    date: "March 27, 2026",
    content: `## A Day at the Kani Loom
...
There are fewer than a thousand people in the world who can do this work. Each piece is a document of their knowledge.`,
  },
  {
    ...
    title: "How to Look After a Pashmina Shawl So It Lasts Decades",
    category: "Care Guide",
    categoryColor: "bg-gold text-charcoal",
    excerpt:
      "Pashmina gets better with age — if you treat it right. Here are the simple rules that will keep your shawl beautiful for thirty years and beyond.",
    readTime: "5 min read",
    image: "https://thepashm.com/cdn/shop/articles/Making_of_Pashmina.jpeg?v=1573582139",
    date: "March 27, 2026",
    content: `## The Simple Rules of Pashmina Care
...
Every piece we sell comes with our unconditional authenticity guarantee. If any shawl you purchase from The Kashmir Weaver is found to be anything other than genuine Kashmiri Pashmina, we will refund you in full — no conditions, no time limit. We stand behind our artisans and their work.`,
  },
  {
    ...
    image: "https://thepashm.com/cdn/shop/articles/Making_of_Pashmina.jpeg?v=1573582139",
    date: "March 26, 2026",
    content: `## Three Fibres, Three Different Things
...
| Typical price | Premium | Mid to high | Affordable |`,
  },
  {
    ...
    readTime: "7 min read",
    image: `${CDN}/amir-khusru-kashmir-agar-firdous.jpg`,
    date: "March 20, 2026",
    content: `## A Pattern with Two Names
