            ...
            >
              ...
              <div className="reveal lg:[direction:ltr]">
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  {type.id === "kani" ? (
                    <a
                      href={siteConfig.shop.kani}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="font-accent inline-flex items-center gap-2 rounded-full bg-gold px-8 py-3 text-[10px] font-semibold tracking-[0.2em] uppercase text-charcoal transition-all hover:scale-105 hover:bg-gold-muted"
                    >
                      Shop Kani
                    </a>
                  ) : type.id === "plain" ? (
                    <a
                      href={siteConfig.shop.solids}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="font-accent inline-flex items-center gap-2 rounded-full bg-gold px-8 py-3 text-[10px] font-semibold tracking-[0.2em] uppercase text-charcoal transition-all hover:scale-105 hover:bg-gold-muted"
                    >
