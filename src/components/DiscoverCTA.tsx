    ...
    <section className="relative overflow-hidden bg-charcoal py-20 sm:py-28">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        <div className="reveal">
          ...
          <h2 className="mt-4 font-heading text-4xl font-bold text-ivory sm:text-5xl lg:text-6xl">
          ...
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <a
              ...
              className="font-accent inline-flex items-center gap-2 bg-gold px-8 py-3 text-[11px] font-semibold tracking-[0.2em] uppercase text-charcoal transition-opacity hover:opacity-85"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="font-accent inline-flex items-center gap-2 border border-ivory/20 px-8 py-3 text-[11px] font-light tracking-[0.2em] uppercase text-ivory transition-colors hover:border-ivory/40 hover:bg-ivory/5"
            >
        ...
        <div className="mt-14">
          ...
          <div
            ref={embedRef}
            className="mx-auto max-w-lg overflow-hidden border border-ivory/10"
          >
            <InstagramFacade
