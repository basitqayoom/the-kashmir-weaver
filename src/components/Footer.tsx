          ...
          <div className="lg:col-span-4">
            ...
            <div className="mt-6 flex gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full border border-ivory/15 text-ivory/50 transition-all hover:border-[#0A66C2]/50 hover:text-[#0A66C2]"
                aria-label="LinkedIn"
              >
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full border border-ivory/15 text-ivory/50 transition-all hover:border-[#4285F4]/50 hover:text-[#4285F4]"
