            ...
            <div className="rounded-2xl bg-charcoal p-6 text-ivory sm:p-8">
              ...
              <div className="mt-6 space-y-5">
                <div className="flex items-start gap-3">
                  <svg className="mt-0.5 h-5 w-5 flex-shrink-0 text-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                  </svg>
                  <div>
                    <p className="text-sm font-medium text-ivory/60">Email</p>
                    <a href={`mailto:${siteConfig.contact.email}`} className="text-sm text-ivory hover:text-gold transition-colors">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-ivory/60">Phone</p>
                    <p className="text-sm text-ivory">{siteConfig.contact.phoneDisplayFull}</p>
                  </div>
                </div>

                <div className="flex items-start gap-3">
                  <svg className="mt-0.5 h-5 w-5 flex-shrink-0 text-gold" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <p className="text-sm font-medium text-ivory/60">WhatsApp</p>
                    <a
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-ivory/60">Address</p>
                    <p className="text-sm text-ivory">
                      {siteConfig.address.line1},
                      <br />
                      {siteConfig.address.city}, {siteConfig.address.stateShort} {siteConfig.address.postalCode}
                    </p>
                    <a
                      href={siteConfig.address.mapsUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="mt-1 inline-flex items-center gap-1 text-xs text-gold hover:text-gold-muted transition-colors"
                    >
