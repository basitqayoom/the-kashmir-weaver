            ...
            <div className="p-8 sm:p-10 lg:p-12">
              ...
              <div className="mt-8">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-gold px-8 py-3 text-sm font-semibold text-charcoal transition-all hover:scale-105 hover:bg-gold-muted"
                >
                  Shop Online
                </a>
              </div>
