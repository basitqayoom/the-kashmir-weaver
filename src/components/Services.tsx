  ...
  return (
    <section id="services" className="bg-ivory bg-linen py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* B2C Section */}
        <div className="reveal mt-16 overflow-hidden border border-gold/15 bg-white">
            ...
            <div className="p-8 sm:p-10 lg:p-12">
              ...
              <div className="mt-8">
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-whatsapp px-8 py-3 text-sm font-semibold text-white transition-opacity hover:opacity-85"
                >
        ...
        <div className="reveal">
          <div className="grid gap-6 sm:grid-cols-3">
            {b2bCards.map((card, i) => (
              <div
                key={i}
                className="group border border-gold/15 bg-white p-8 text-center transition-colors hover:border-gold/30"
              >
          ...
          <div className="mt-10 text-center">
            <a
              href="#contact"
              className="inline-block bg-burgundy px-8 py-3.5 text-sm font-semibold text-ivory transition-colors hover:bg-burgundy-light"
            >
        ...
        {/* Bespoke subsection */}
        <div className="reveal mt-16 overflow-hidden bg-charcoal">
            ...
            <div className="p-8 sm:p-10 lg:col-span-3 lg:p-12">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                {["Plain: 4–6 weeks", "Embroidered: 8–16 weeks", "Kani: up to 6 months"].map((t, i) => (
                  <span key={i} className="border border-gold/25 px-4 py-1.5 text-sm text-ivory/70">
                    {t}
                  </span>
                ))}
              </div>
              <div className="mt-8">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-gold px-8 py-3 text-sm font-semibold text-charcoal transition-opacity hover:opacity-85"
                >
